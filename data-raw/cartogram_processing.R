...
names(provinces_territories_carto_df) <- c("long", "lat", "order", "hole", "piece", "pr_english", "group", "year", "population")


provinces_territories_carto_df$pr_alpha <- dplyr::recode(provinces_territories_carto_df$pr_english,
...
provinces_territories_carto_df$pr_french <- dplyr::recode(provinces_territories_carto_df$pr_alpha,
...
provinces_territories_carto_df$pr_sgc_code <- dplyr::recode(provinces_territories_carto_df$pr_alpha,
                                                 `NL` = 10L,
                                                 `PE` = 11L,
                                                 `NS` = 12L,
                                                 `NB` = 13L,
...
provinces_territories_carto_df <- provinces_territories_carto_df %>%
  select(-year)


names(provinces_territories_carto_df)
# Save data
